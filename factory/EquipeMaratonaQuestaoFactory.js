...
module.exports = (options) => {
    return {
        ...
        pontuacao: options.maratona.encerada ? faker.random.number({
            min: 1,
            max: 100
        }) : null,
        tentativas: options.maratona.encerada ? faker.random.number({
            min: 1,
            max: 15
        }) : 0,
        inscricao_termino: options.maratona.encerada ?
